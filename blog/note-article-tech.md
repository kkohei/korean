...
**「欲しい道具がないなら、作ればいい」** ── そう言うのは簡単ですが、実際にやると“配る”ところで詰まります。
この記事は、Macの常駐型 日↔韓 翻訳アプリを、**企画から実装、署名・公証、配布、収益化の設計まで**ひと通り通した実録です。
コードが専門でない私が、AIとペアプロで**どこまで・いくらで**やれたのか、再現できる形で全部残します。
...
#個人開発 #副業 #プログラミング #Swift #SwiftUI #Mac #Macアプリ #AI #Claude #個人開発で稼ぐ #ものづくり #エンジニア #駆け出しエンジニア #アプリ開発
